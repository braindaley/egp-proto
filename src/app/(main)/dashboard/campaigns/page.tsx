...
import { ExternalLink, Edit2, Trash2, Loader2, BarChart3, Mail, Menu, ChevronRight, User as UserIcon, Settings, MessageSquare, Crown, Megaphone, Eye } from 'lucide-react';
...
export default function CampaignsPage() {
        ...
        try {
            ...
            for (const campaign of campaigns) {
                ...
                const otherCampaignsForBill = querySnapshot.docs
                    .filter(doc => doc.data().groupSlug !== selectedGroup) // Filter client-side
                    .map(doc => {
                        const data = doc.data();
    ...
    const dashboardNavItems = [
        ...
        { label: 'Manage Campaigns', href: '/dashboard/campaigns', icon: Megaphone, isActive: true },
    ];
                                                            ...
                                                            <CardHeader>
                                                                <div className="flex justify-between items-start">
                                                                    ...
                                                                    <div className="flex gap-2">
                                                                        ...
                                                                        >
                                                                            <Link 
                                                                                href={`/campaigns/${selectedGroup}/${campaign.bill.type?.toLowerCase()}-${campaign.bill.number}`}
                                                                                target="_blank"
                                                                            >
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            asChild
                                                                        >
                                                                            <Link href={`/dashboard/campaigns/performance/${campaign.id}`}>
                                                                        ...
                                                                        <Button
                                                                            ...
                                                                            asChild
                                                                        >
                                                                            <Link href={`/dashboard/campaigns/emails/${campaign.id}`}>
