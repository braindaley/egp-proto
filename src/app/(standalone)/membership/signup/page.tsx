            ...
            <form onSubmit={handlePaymentSubmit} className="space-y-6">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-primary">$6/quarter</span>
                    <span className="text-sm text-muted-foreground">$24/year</span>
                  </div>
                ...
                <div className="text-xs text-muted-foreground bg-muted p-3 rounded-md">
                  By completing this purchase, you agree to be charged $6.00 every quarter starting today.
